...
import { Container, UserName, MessageContainer, TxtMessage, TxtContainer, MessageContainer2, UserName2, TxtContainer2, TxtMessage2 } from './styles';
...
const ChatScreen = () => {
    return <Container>
        ...
        <Icon style={{transform: [{ rotate: '45deg'}]}} name="attachment" size={24} color="gray" />
        </ScrollView>
    </Container>
}
